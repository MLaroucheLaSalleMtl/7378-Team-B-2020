    ...
    public class RC_Camera_CS : MonoBehaviour
    {
		...
		*/
        ...
        void Initialize()
        {
            ...
            // Get the input type.
            var managerScript = FindObjectOfType<Input_Type_Manager_CS>();
            if (managerScript)
            {
                inputType = managerScript.Input_Type;
            }
        ...
        void LateUpdate()
        {
            if (targetCameraScript == null || targetCameraScript.Is_Selected == false)
