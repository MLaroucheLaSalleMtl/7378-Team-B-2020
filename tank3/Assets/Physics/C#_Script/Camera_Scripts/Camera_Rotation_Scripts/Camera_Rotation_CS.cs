...
namespace ChobiAssets.PTM
{
	...
	public class Camera_Rotation_CS : MonoBehaviour
	{
		...
		*/
        ...
        public bool Use_Clamp = true;
        public bool Simulate_Head_Physics = true;
		...
		void Rotate_FPV ()
        {
            ...
            // Vertical rotation.
            if (Simulate_Head_Physics)
            {
                currentLocalAngles = Simulate_Head_Vertical_Rotation(currentLocalAngles);
            }
            else
            {
                currentLocalAngles = Simple_Vertical_Rotation(currentLocalAngles);
            }
        ...
        Vector3 Simple_Vertical_Rotation(Vector3 currentLocalAngles)
        {
            ...
            return currentLocalAngles;
        }


        Vector3 Simulate_Head_Vertical_Rotation(Vector3 currentLocalAngles)
        {
            // Vertical and rolling rotation.
            if (Vertical_Input == 0.0f && Mathf.Abs(Mathf.DeltaAngle(0.0f, currentLocalAngles.z)) < 10.0f)
            { // The vertical input is zero, and the camera is almost horizotal.
            ...
            { // The vertical input is not zero, and the camera is not horizotal.
                // X axis (Rolling rotation).
        ...
        public void Reset_Vertical_Rotation()
        {
            targetAngles.z = 0.0f;
        }
