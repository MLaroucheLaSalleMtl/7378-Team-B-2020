...
public class LightTankFireLevel2 : MonoBehaviour
{
    public LightTankMoveLevel2 LightTankMoveLevel2;
    ...
    void Update()
    {
        CalculateTime(LightTankMoveLevel2.DistanceBetweenTwo, speed);




        Debug.DrawRay(generator.position, generator.forward, Color.red);
        if (LightTankMoveLevel2.isdetected == true)
        {
            isfiring = true;
        }
    ...
    public void TurretRotation()
    {
        ...
        {
            if (LightTankMoveLevel2.collider_exist)
            {
