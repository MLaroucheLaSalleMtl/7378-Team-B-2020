	...
	public class Static_Track_Setting_CS : MonoBehaviour
	{
		...
		*/
		...
		void Set_Type ()
		{
			...
			Collider[] hitColliders = Physics.OverlapSphere (thisTransform.position, 0.1f, Layer_Settings_CS.Layer_Mask);
		...
		{ // Called from "Create_TrackBelt_CSEditor".
			...
			for (int i = 0; i < transform.childCount; i++) {
				...
				if (childObject.layer == Layer_Settings_CS.Reinforce_Layer) { // Reinforce.
        ...
        { // Called from "Create_TrackBelt_CSEditor".
            ...
            Static_Track_Piece_CS pieceScript = gameObject.GetComponent<Static_Track_Piece_CS>();
