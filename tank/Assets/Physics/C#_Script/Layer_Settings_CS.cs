...
namespace ChobiAssets.PTM
{
    ...
    public class Layer_Settings_CS
    {
        ...
        // Layer Mask settings.
        public const int Layer_Mask = ~((1 << 2) + (1 << Reinforce_Layer) + (1 << Extra_Collider_Layer)); // Ignore "Layer 2(Ignore Ray)", "Reinforce_Layer", "Extra_Collider_Layer".
        public const int Aiming_Layer_Mask = ~((1 << 2) + (1 << Reinforce_Layer) + (1 << Wheels_Layer) + (1 << Extra_Collider_Layer)); // Ignore "Layer 2(Ignore Ray)", "Reinforce_Layer", "Wheels_Layer", "Extra_Collider_Layer".
